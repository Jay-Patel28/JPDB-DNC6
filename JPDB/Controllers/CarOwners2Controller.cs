...
namespace JPDB.Controllers
{
    ...
    [ApiController]
    public class CarOwners2Controller : ControllerBase
    {
        private readonly JPDBContext _context;

        public CarOwners2Controller(JPDBContext context)
        {
            _context = context;
        }
